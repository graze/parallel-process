...
class TableTest extends TestCase
{
    ...
    public function testProgressBar()
    {
        ...
        $expected = [
            ...
            ['%<info>key</info>: value \(<comment>  0.00s</comment>\) <fg=black;bg=cyan>  </>%'],
            ['%<info>key</info>: value \(<comment>  0.05s</comment>\) <fg=black;bg=cyan>▏ </>%'],
            ['%<info>key</info>: value \(<comment>  0.10s</comment>\) <fg=black;bg=cyan>▎ </>%'],
            ['%<info>key</info>: value \(<comment>  0.15s</comment>\) <fg=black;bg=cyan>▍ </>%'],
            ['%<info>key</info>: value \(<comment>  0.20s</comment>\) <fg=black;bg=cyan>▍ </>%'],
            ['%<info>key</info>: value \(<comment>  0.25s</comment>\) <fg=black;bg=cyan>▌ </>%'],
            ['%<info>key</info>: value \(<comment>  0.30s</comment>\) <fg=black;bg=cyan>▋ </>%'],
            ['%<info>key</info>: value \(<comment>  0.35s</comment>\) <fg=black;bg=cyan>▋ </>%'],
            ['%<info>key</info>: value \(<comment>  0.40s</comment>\) <fg=black;bg=cyan>▊ </>%'],
            ['%<info>key</info>: value \(<comment>  0.45s</comment>\) <fg=black;bg=cyan>▉ </>%'],
            ['%<info>key</info>: value \(<comment>  0.50s</comment>\) <fg=black;bg=cyan>█ </>%'],
            ['%<info>key</info>: value \(<comment>  0.55s</comment>\) <fg=black;bg=cyan>█▏</>%'],
            ['%<info>key</info>: value \(<comment>  0.60s</comment>\) <fg=black;bg=cyan>█▎</>%'],
            ['%<info>key</info>: value \(<comment>  0.65s</comment>\) <fg=black;bg=cyan>█▍</>%'],
            ['%<info>key</info>: value \(<comment>  0.70s</comment>\) <fg=black;bg=cyan>█▍</>%'],
            ['%<info>key</info>: value \(<comment>  0.75s</comment>\) <fg=black;bg=cyan>█▌</>%'],
            ['%<info>key</info>: value \(<comment>  0.80s</comment>\) <fg=black;bg=cyan>█▋</>%'],
            ['%<info>key</info>: value \(<comment>  0.85s</comment>\) <fg=black;bg=cyan>█▋</>%'],
            ['%<info>key</info>: value \(<comment>  0.90s</comment>\) <fg=black;bg=cyan>█▊</>%'],
            ['%<info>key</info>: value \(<comment>  0.95s</comment>\) <fg=black;bg=cyan>█▉</>%'],
